...
import SimpleGUICS2Pygame.simpleguics2pygame as simplegui           # Importing SIMPLE GUI for graphics 
import random                                                       # Importing RANDOM module


# Card Placement and image
...
# Cards and The Values Of The card in Lists
...
frame = simplegui.create_frame("Blackjack", 600, 600)                   # Canvas Frame 
frame.set_canvas_background("#00cc44")
